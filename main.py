...
case'play_turn':logText(`${tr('seat')} ${p.seat+1} ${p.player_name}: ${tr('play')}${p.is_opening?' · '+tr('round'):' · '+tr('must_play_higher')+' '+(p.last_player_name||'')+' '+comboText(p.last_combo,p.combo_display)}`);break;
